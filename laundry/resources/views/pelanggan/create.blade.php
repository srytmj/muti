            ...
            <div class="card-body">
                ...
                <form action="/pelanggan" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control form-control-solid" id="alamat_pelanggan" name="alamat_pelanggan" rows="3" placeholder="Contoh: Jl. Bunga Matahari No. 16">{{ old('alamat_pelanggan') }}</textarea>
                    </div>
