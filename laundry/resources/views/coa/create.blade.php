          ...
          <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Data Coa</h5>
                ...
                <form action="{{ route('coa.store') }}" method="post">
                    ...
                    <input class="form-control form-control-solid" id="kode_akun" name="kode_akun" type="text" placeholder="Contoh: 111" value="{{old('nama_akun')}}">
                    </div>
                    ...
                    <input class="form-control form-control-solid" id="header_akun" name="header_akun" type="text" placeholder="Contoh: 1 (Harta), 2 (Kewajiban), 3 (Modal), 4 (Pendapatan), 5 (Beban)" value="{{old('header_akun')}}">
                    </div>
                    <br>
                    <!-- untuk tombol simpan -->
