                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-8">
                                ...
                                <a href="#collapseCardExample{{$p->id}}" class="d-block card-header py-3" data-toggle="collapse"
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">{{ $p->nama_layanan }}</h6>
                                    <h6 class="m-0 font-weight-bold text-primary">{{ $p->jenis_layanan }}</h6>
                                </a>
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-body">
            ...
            <input type="hidden" id="tipeproses" name="tipeproses" value="">
                ...
                <div class="mb-3 row">
                    <label for="nomerlabel" class="col-sm-4 col-form-label">Nama Layanan</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="nama_layanan" name="nama_layanan" readonly>
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="lantailabel" class="col-sm-4 col-form-label">Harga</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="harga" name="harga" readonly>
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="hargalabel" class="col-sm-4 col-form-label">Jumlah Kilogram</label>
                    <div class="col-sm-8">
