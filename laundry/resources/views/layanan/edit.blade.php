            ...
            <h5 class="card-title fw-semibold mb-4">Layanan</h5>
                ...
                <form action="{{ route('layanan.update', $layanan->id) }}" method="post">
                    ...
                    <div class="mb-0"><label for="tariflabel">Layanan</label>
                        <textarea class="form-control form-control-solid" id="layanan" name="layanan" rows="3" placeholder="Cth: Cuci Kering">{{$layanan->layanan}}</textarea>
                    </div>
                    ...
                    <div class="mb-0"><label for="tariflabel">Tarif</label>
                        <textarea class="form-control form-control-solid" id="tarif" name="tarif" rows="3" placeholder="Cth: 20000">{{$layanan->tarif}}</textarea>
                    </div>
                    <br>
                    <!-- untuk tombol simpan -->
