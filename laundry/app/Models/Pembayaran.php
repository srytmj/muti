...
class Pembayaran extends Model
{
    ...
    public static function updateStatusKonformasiPembayaran($no_transaksi,$id_pelanggan)
    {
    ...
    // viewstatus pembayaran seluruh pelanggan
    public static function viewstatusall()
    {
        ...
        $sql = "SELECT a.id,a.no_transaksi,DATE_FORMAT(a.tgl_bayar,'%Y-%m-%d') as tgl_bayar,a.tgl_konfirmasi,a.bukti_bayar,
                        ...
                        b.total_harga,
                        GROUP_CONCAT(d.nama_layanan ORDER BY d.nama_layanan) as list_layanan
                FROM pembayaran a
                ...
                LEFT OUTER JOIN layanan d
                ON (c.id_layanan=d.id)
    ...
    // untuk view status pembayaran berdasarkan id pelanggan tertentu
    public static function viewstatus($id_pelanggan)
    {
        // query kode perusahaan
        $sql = "SELECT a.id,a.no_transaksi,a.tgl_bayar,a.tgl_konfirmasi,a.bukti_bayar,
                ...
                GROUP BY a.id,a.no_transaksi,a.tgl_bayar,a.tgl_konfirmasi,a.bukti_bayar,
                        a.jenis_pembayaran,a.status,
                        b.total_harga";
        $list = DB::select($sql,[$id_pelanggan]);

        return $list;
    }

    // untuk view status pembayaran berdasarkan id pelanggan tertentu untuk PG
    public static function viewstatusPG($id_pelanggan)
    {
        // query kode perusahaan
        $sql = "SELECT b.*,c.status_code,c.transaction_status,c.settlement_time
                ...
                WHERE b.id_pelanggan = ? AND b.status in ('selesai','siap_bayar')
